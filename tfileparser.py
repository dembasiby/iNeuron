...
class FileParser:
    ...
    @classmethod
    def word_counter(cls, words_list:list):
        """
    ...
    @classmethod
    def word_group_counter(cls, words_list: list):
        """
        Input: A list of words
        ...
        """
        try:
            first_letters = set([ e[0] for e in words_list ])
            first_letters_list = [ e[0] for e in words_list]
